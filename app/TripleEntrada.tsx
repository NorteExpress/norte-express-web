    ...
    const ecosystem = [
        {
            ...
            icon: <svg className="w-8 h-8 text-[#f39200]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
        },
        {
            ...
            span: "md:col-span-1 lg:col-span-2",
            icon: <svg className="w-8 h-8 text-[#f39200]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m4 6h.01M5 20h14a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
        },
        {
            ...
            icon: <svg className="w-8 h-8 text-[#f39200]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
        },
        {
        ...
        },
        {
            ...
            span: "md:col-span-1 lg:col-span-3",
            icon: <svg className="w-8 h-8 text-[#f39200]" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" /></svg>
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8">
                    {ecosystem.map((item, index) => (
                        <div key={index} className={`group relative bg-[#132540]/80 backdrop-blur-3xl border border-white/10 hover:border-[#f39200]/50 rounded-[2.5rem] p-10 lg:p-12 transition-all duration-700 ease-out transform-gpu hover:-translate-y-4 hover:shadow-[0_40px_80px_-20px_rgba(243,146,0,0.3)] flex flex-col h-full ${item.span}`}>
                            ...
                            <div className="relative z-10 flex flex-col h-full">
                                <div className="flex justify-between items-start mb-8 gap-4">
                                    <div className="w-16 h-16 bg-gradient-to-br from-[#1c355c] to-[#0f1d35] rounded-2xl flex items-center justify-center border border-white/10 group-hover:border-[#f39200]/50 group-hover:shadow-[0_0_30px_rgba(243,146,0,0.5)] transition-all duration-700 group-hover:-translate-y-2 shrink-0">
                                        {item.icon}
                                    </div>
                                    <span className="bg-[#f39200]/10 text-[#f39200] px-4 py-1.5 rounded-full text-[10px] md:text-xs font-bold uppercase tracking-widest border border-[#f39200]/20 text-right mt-1">
                                        {item.category}
                                    </span>
                                </div>
